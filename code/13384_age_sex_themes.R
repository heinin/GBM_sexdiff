...
# Leukapheresis PBMC celltype colors
leukPBMC_celltypes <- c("NK", "CD4 T", "CD8 T", "Mono", "other T", "DC", "B", "other")
leukPBMC_celltype_1_col <- c("dodgerblue3", "deepskyblue2", "skyblue", "seagreen3", "cadetblue", "slateblue", "darkseagreen4", "gray75")

leukPBMC_celltypes_2 <- c("NK",
                        "CD4 TCM",
                        "CD8 TCM",
                        "CD14 Mono",
                        "CD8 Naive",
...
leukPBMC_celltype_2_col <- colorRampPalette(brewer.pal(11, "Paired"))(length(leukPBMC_celltypes_2))
names(leukPBMC_celltype_2_col) <- leukPBMC_celltypes_2
